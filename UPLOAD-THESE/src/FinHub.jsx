...
const DOMAINS = [
  { id: 'fundamentals', icon: 'fundamentals', name: 'Finance Fundamentals', kicker: 'Where every path begins',
  ...
  { id: 'investments', icon: 'investments', name: 'Investments', kicker: 'Turning capital into claims',
  ...
  { id: 'markets', icon: 'markets', name: 'Financial Markets', kicker: 'Where prices are discovered',
  ...
  { id: 'banking', icon: 'banking', name: 'Banking & Institutions', kicker: 'The plumbing of finance',
  ...
  { id: 'derivatives', icon: 'derivatives', name: 'Derivatives & Risk', kicker: 'Pricing the uncertain',
  ...
  { id: 'economics', icon: 'economics', name: 'Economics & Global Finance', kicker: 'The forces above the firm',
  ...
  { id: 'case-studies', icon: 'cases', name: 'Case Studies', kicker: 'Finance as it actually happened', blurb: 'Decisions, outcomes and the concepts that explain them.', route: '#/cases' },
  { id: 'frauds', icon: 'frauds', name: 'Financial Frauds', kicker: 'Mechanisms, not morality tales', blurb: 'How the deception worked, and which numbers gave it away.', route: '#/frauds' },
  ...
  { id: 'scenarios', icon: 'scenarios', name: 'Scenario Analysis', kicker: 'Cause and effect, traced', blurb: 'Follow a shock from event to financial implication.', route: '#/scenarios' },
...
const CONCEPTS = [
  {
    ...
    caseRef: null,
    related: ['compounding', 'inflation', 'discount-rate', 'real-return', 'bond-pricing'],
    prereq: [],
  ...
  },
  {
    ...
    caseRef: 'lehman-2008',
    related: ['risk-return', 'discount-rate', 'interest-rates'],
  ...
  return (
    <>
      ...
      <div className="wrap" style={{ paddingBottom: 80 }}>
        ...
        <Reveal delay={70}>
          <p className="lede" style={{ marginTop: 14, maxWidth: "58ch" }}>
            Precise definitions, a plain-language reading, and a route into the concept behind the term.
          </p>
        </Reveal>
        <div className="field" style={{ marginTop: 26, maxWidth: 420 }}>
          <label htmlFor="gq">Filter terms</label>
          <input id="gq" value={q} onChange={(e) => setQ(e.target.value)} placeholder="e.g. duration" />
        </div>
        {list.length === 0 && <p className="small">No term matches “{q}”.</p>}
        <div className="grid g2">
          {list.map((g, i) => (
            <Reveal key={g.term} delay={Math.min(i * 40, 260)}>
              <div className="card" style={{ height: "100%" }}>
                <h3 style={{ fontSize: 18 }}>{g.term}</h3>
                <p className="small" style={{ marginTop: 8, color: "#C7D2E6" }}>{g.def}</p>
                <p className="small" style={{ marginTop: 10, fontStyle: "italic" }}>{g.simple}</p>
                {g.formula && <div className="formula" style={{ fontSize: 13, padding: 10, marginTop: 12 }}>{g.formula}</div>}
                {conceptById(g.link) && (
                  <a className="chip" href={`#/concept/${g.link}`} style={{ marginTop: 14, display: "inline-block" }}>
